...
export default () => (
  <Page id="manual">
    ...
    <Main class="ion-padding">
      <h3>Fixed point photography</h3>
      <Section>
        <H>Background</H>
        <P>
          The aim of this survey is to develop a visual record of the sand dune
          system using fixed point photographs. This will allow assessments to
          be made of how the morphology and vegetation composition of sites are
          changing over time.
        </P>
      </Section>
      <Section>
      ...
      <Section>
        <P>
          <i>Navigating to the photography points</i>
          <ul>
            <li>
